...
import group2 from "../assets/Group 2.webp"
import group3 from "../assets/Group 3.webp"
  ...
  return (
    <div className="font-sans">
      ...
      <div className="w-full mt-0 lg:mt-10 relative">
        ...
        {/* About Us Content */}
        <motion.div
        className="flex flex-col items-center justify-center mt-10  text-left px-6 lg:px-20 mb-20 lg:mb-48">
          ...
          viewport={{once:true}}
          className="w-full h-fit" src={group1} alt="" /> <br />
          <motion.img
          initial={{opacity:0}}
          whileInView={{opacity:1}}
          transition={{duration:2}}
          viewport={{once:true}}
          className="w-full h-fit" src={group2} alt="" /> <br />
          <motion.img
          initial={{opacity:0}}
          whileInView={{opacity:1}}
          transition={{duration:2}}
          viewport={{once:true}}
          className="w-full h-fit" src={group3} alt="" />
        </motion.div>
