      ...
      <div className="w-full mt-0 lg:mt-10 relative">
        ...
        <div className="flex flex-col items-center justify-center mt-10  text-left px-6 lg:px-20 mb-20 lg:mb-48">
          ...
          viewport={{once:true, amount:.5
           ...
           className="font-san w-full">
            <ul className="list-decimal">
              <li className="text-[14px] lg:text-[20px] font-bold">
                What types of furniture do you make?
              </li>
              <p className="text-[10px] lg:text-[14px] mt-2">
                We create a wide range of furniture, including doors, beds,
                window frames, decorative panels, wooden screens, and
                custom-designed pieces to suit your specific needs.
              </p>
              <li className="text-[14px] lg:text-[20px] font-bold mt-6">
                Can I request a custom design?
              </li>
              <p className="text-[10px] lg:text-[14px] mt-2">
                Yes, we specialize in custom designs. Share your ideas or
                requirements with us, and we’ll craft furniture that fits your
              ...
              <p className="text-[10px] lg:text-[14px] mt-2">
                We use high-quality, durable wood and other sustainable
                materials to ensure our furniture is long-lasting and
                eco-friendly.
              </p>
              <li className="text-[14px] lg:text-[20px] font-bold mt-6">
              ...
              <p className="text-[10px] lg:text-[14px] mt-2">
                The time depends on the size and complexity of your order, but
                we’ll give you an estimated timeline during the consultation.
              </p>
              <li className="text-[14px] lg:text-[20px] font-bold mt-6">
                Do you deliver and install the furniture?
              </li>
              <p className="text-[10px] lg:text-[14px] mt-2">
                Yes, we offer delivery and installation services to make the
