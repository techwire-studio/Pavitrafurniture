...
// const Testimonials = () => {
//   return (
//     <div className="mt-10 lg:mt-20 font-sans px-6 sm:px-10 lg:px-20">
//       {/* Title Section */}
//       <motion.h1
...
//                 <p className="font-normal text-[12px] lg:text-[20px] text-text-company">{testimonial.name}</p>
//                 <p className="text-[10px] lg:text-[14px] font-thin text-text-company">{testimonial.company}</p>
//               </div>
//             </div>
//           </motion.div>
//         ))}
...
//             }}
//           >
//             <img className="w-24 sm:w-32 lg:w-40" src={company} alt={`Company ${index + 1}`} />
//           </motion.div>
//         ))}
//       </motion.div>
//     </div>
...
const Testimonials = () => {
  ...
  return (
    <div className="mt-10 lg:mt-20 font-sans px-4 sm:px-10 lg:px-20">
      ...
      {/* Desktop Grid View - Unchanged from previous implementation */}
      <motion.div
        className="hidden md:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={{
      ...
      >
        {testimonials.map((testimonial, index) => (
          ...
          >
            {/* Desktop testimonial card content */}
            <div>
              <img className="p-4 w-16" src={symbol} alt="Symbol" />
            </div>
            <div className="text-left text-[14px] lg:text-[20px] ml-8">
