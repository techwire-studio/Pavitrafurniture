...
const Contact = () => {
  return (
    <div className="w-full font-sans h-fit bg-bg-contact grid lg:grid-cols-2 mt-20 grid-cols-1">
      {/* Left Section */}
      <motion.div 
      ...
      className="flex justify-center lg:justify-start lg:ml-20 lg:mt-8 items-center lg:items-start">
        <h1 className="text-[32px] sm:text-[48px] lg:text-[48px] font-bold text-bg-primary ">
          Contact Us
        </h1>
      </motion.div>
